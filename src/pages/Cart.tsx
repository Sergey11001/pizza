...
import {useAppSelector} from "../redux/useAppHooks";
...
export function Cart(){
    ...
    const {clearItems} = useAppDispatch()
            ...
            <div className="cart">
                ...
                <div className="cart__bottom">
                    <div className="cart__bottom-details">
                        <span> Всего пицц: <b>{items.reduce((sum:number,item:CartItem)=>sum+item.count,0)} шт.</b> </span>
                        <span> Сумма заказа: <b>{items.reduce((sum:number,item:CartItem)=>sum+item.count*item.price,0)} ₽</b> </span>
                    </div>
